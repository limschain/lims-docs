...
**(1)生成单个样品报告** 点击待生成检测报告样品记录右端的[检测报告]，弹出[报告生成操作页面](#报告生成操作页面)，执行[报告生成操作](#报告生成)。
...
- **报告编辑** 编辑检测报告，支持电子签名、电子签章（包括资质章、公章）

- **报告审核** 对检验报告进行审核，支持电子签名

- **报告签发** 签发检验报告出厂，支持电子签名
...
**1)报告编辑** 点击待编辑检测报告记录右端的【操作】-->【报告编辑】，弹出[报告编辑信息页面](#报告编辑信息页面)，执行[报告编辑操作](#报告编辑)。


**2)报告审核** 点击待编辑检测报告记录右端的【操作】-->【报告审核】，弹出[报告审核信息页面](#报告审核信息页面)，执行[报告审核操作](#报告审核)。

**3)报告签发** 点击待签发检测报告记录右端的【操作】-->【报告签发】，弹出[报告签发信息页面](#报告签发信息页面)，执行[报告签发操作](#报告签发)。
